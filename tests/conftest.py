...
from clinics.models import Clinic, Speciality, Doctor, DoctorSchedule, NonInsuredMedicalCategory, ClinicAppointment
...
@pytest.fixture
def create_clinic_appointment(db, setup_test_database):
    setup_test_database

    def create_appointment(desired_date, expired_at):
